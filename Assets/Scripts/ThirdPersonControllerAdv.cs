...
#endif
    public class ThirdPersonControllerAdv : MonoBehaviour
    {
        [Header("Animator")]
        [SerializeField]
        ...
        [SerializeField]
        private bool _RotateByDirection = false;
        ...
        [Range(0, 1)]
        public float MouseCameraRotationMultiply = 1;
        ...
        private bool HasAnimator
        {
            get
            {
                if (_animator != null)
                    return true;
                return TryGetComponent(out _animator);
            }
        }
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                float deltaTimeMultiplier = IsCurrentDeviceMouse ? MouseCameraRotationMultiply : Time.deltaTime;
        ...
        private void Move()
        {
            ...
            if (_RotateByDirection)
            {
                ...
                else
                {
                    ...
                    float newAniParamSpeed = _speed / Mathf.Abs(maxSpeed);
                    if (!_input.sprint)
                    {
            ...
            {
                float newAniParamSpeed = _input.move.y;
                float newAniParamDirection = _input.move.x;
                if (!_input.sprint)
                {
                    newAniParamSpeed = Mathf.Clamp(newAniParamSpeed, -0.7f, 0.7f);
