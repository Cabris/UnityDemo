...
//     version 1.11.2
//     from Assets/_Standard Assets/Characters/Scriptable Objects/Control Map/StandardControls.inputactions
//
...
public partial class @StandardControls: IInputActionCollection2, IDisposable
{
    ...
    ~@StandardControls()
    {
        UnityEngine.Debug.Assert(!m_Movement.enabled, "This will cause a leak and performance issues, StandardControls.Movement.Disable() has not been called.");
    }
