...
namespace StandardAssets.Characters.Effects
{
    ...
    public abstract class MovementEventHandler
    {
        ...
        PhysicsMaterial m_PhysicMaterial;
        ...
        /// </summary>
        protected void SetPhysicMaterial(PhysicsMaterial physicMaterial)
        {
        ...
        void ChangeMovementZone(PhysicsMaterial physicMaterial)
        {
    ...
    public class MovementEventZoneDefinition
    {
        ...
        /// Gets the zoneId
        /// </summary>
        public PhysicsMaterial physicMaterial { get { return m_PhysicMaterial; } }
    ...
    public class MovementEventZoneDefinitionList
    {
        ...
        public MovementEventLibrary this[PhysicsMaterial physicMaterial]
        {
            get
            {
